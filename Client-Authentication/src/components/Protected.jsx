      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-600">
            You have successfully authenticated and can access protected content.
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow duration-200">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs text-gray-600">Protected route accessed</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Server Response</h2>
          <div className="bg-gray-50 rounded-md p-4">
            <div className="space-y-3">
              ...
              {data.userId && (
                <div>
                  <span className="text-xs font-medium text-gray-700 uppercase tracking-wide">User ID:</span>
                  <p className="text-sm text-gray-900 mt-1 font-mono">{data.userId}</p>
                </div>
              )}
            </div>
          </div>
